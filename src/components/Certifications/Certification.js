...
const ProfileCard = ({name,taglin,img}) => {
  return (
    <div style={{fontFamily:"Manrope,sans-serif"}} className='transition duration-300 hover:scale-105 flex flex-col items-center mx-auto bg-gradient-to-r from-red-400 to-red-700 w-64 justify-center py-5 my-2 sm:w-4/5 sm:h-40 rounded-xl'>
